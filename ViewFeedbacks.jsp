...
tr:hover {background-color:#f5f5f5;}
    ...
    <body>
       ...
       <div class="advice-lidt-bottom wow bounceInRight" data-wow-delay="0.3s">
        ...
        <table id="cstable">
                <tr><th>Name </th><th>Phone </th><th>Email </th><th>Subject </th><th>Details  </th><th>Rating  </th></tr>
                <%
                    DbConnection con= new DbConnection();
                    String qry = "SELECT  f.fid,f.`uid`,u.name,u.`phone`,u.`email`,f.subject,f.`description`,f.`rating`  FROM `feedback` f,`user_registration` u WHERE f.`uid`=u.uid";
        ...
        Iterator it = con.getData(qry).iterator();
            ...
            while (it.hasNext()) {
                ...
                %>
                <tr>
                    <td><%=v.get(2)%></td> </td>  <td><%=v.get(3)%></td>  <td><%=v.get(4)%></td>  <td><%=v.get(5)%><td><%=v.get(6)%><td><%=v.get(7)%></td>
                </tr>
